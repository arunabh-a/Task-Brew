    ...
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <main className="relative z-10 container px-4 md:px-6">
        <div className="flex flex-col items-center text-center pt-20 md:pt-32 pb-20">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-10 animate-fade-up" style={{ animationDelay: "100ms" }}>
            A beautiful task management experience that helps you stay focused,
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 animate-fade-up" style={{ animationDelay: "200ms" }}>
            <Button size="lg" variant="link" asChild className="shadow-glow">
              <Link href="/signup">
                Start for free
